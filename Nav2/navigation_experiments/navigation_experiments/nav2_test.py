...
class SetInitialPoseNode(Node):
    ...
    def _do_once(self):
        ...
        # PI == 3.14 == 180
        # PI/2 == 1.57 == 90
        goal_pose1 = self.create_pose_stamped(self.nav, 2.5, 1.0, 1.57)
        goal_pose2 = self.create_pose_stamped(self.nav, 2.0, 2.5, 3.14)
        goal_pose3 = self.create_pose_stamped(self.nav, 0.5, 1.0, -1.57)
